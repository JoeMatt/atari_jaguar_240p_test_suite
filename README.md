...
<p><img src="screenshots/pink-noise/00-pink-noise-idle.png" alt="Pink Noise Test (idle, ready to play)" width="360"><br><sub>Pink Noise Test (idle, ready to play)</sub></p>
